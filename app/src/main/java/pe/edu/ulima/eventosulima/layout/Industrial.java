...
import pe.edu.ulima.eventosulima.beans.Key;
import pe.edu.ulima.eventosulima.services.AlarmService;
;import static pe.edu.ulima.eventosulima.R.color.colorPrimary;


public class Industrial extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Industrial");
        ...
        myFirebaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data : dataSnapshot.getChildren()){
                    ...
                    if(evento.getCarrera().equals("Industrial")) {
